...
// Importando estilos
$css = file_get_contents('../Models/Css/PdfDiseno.css');
// Creando E-Mail
...
$body .= '<h1 class="display-4">Cotizacion Diseño</h1>';
$body .= '<hr>';
...
$data .= '<h1 class="display-4">Cotizacion Diseño</h1>';
$data .= '<hr>';
...
//Attachment
$mail->addStringAttachment($pdf, 'AbinDesign Diseno Cotizacion.pdf');

// Content
$mail->isHTML(true);                                  // Set email format to HTML
$mail->Subject = 'AbinDesign Diseno Cotizacion';
$mail->Body    = $body;
